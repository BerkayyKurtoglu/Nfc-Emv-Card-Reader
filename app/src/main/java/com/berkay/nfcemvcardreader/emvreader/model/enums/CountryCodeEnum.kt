...
/**
 * Represents a country using ISO 3166-1 codes (alpha-2, alpha-3, and numeric).
 *
 * The enum constant names correspond to ISO 3166-1 alpha-2 codes.
 */
enum class CountryCodeEnum(
    ...
    override fun getKey(): Int = numeric
...
//         */
//        fun getCountry(alpha3: String): CountryCodeEnum? {
//            return values().firstOrNull { it.alpha3.equals(alpha3, ignoreCase = true) }
//        }
    }
}
